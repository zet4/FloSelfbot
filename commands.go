...
func (a *AddMultiGameString) Description() string { return "Adds a string to the multi game thing" }
func (a *AddMultiGameString) Usage() string       { return "<game>" }
func (a *AddMultiGameString) Detailed() string {
	return "Adds a string to the multi game thing, which works on a 5 minute timer.\nTo remove strings, edit the config file."
}
